document.addEventListener('DOMContentLoaded', () => {
    ...
    async function fetchMaps() {
        ...
        try {
            const res = await fetch(getApiUrl('/api/list-maps'));
            if (res.ok) {
    ...
    async function deleteMap(mapName) {
        ...
        try {
            const res = await fetch(getApiUrl(`/api/delete-map/${mapName}`), { method: 'DELETE' });
            if (res.ok) {
    ...
    async function saveMap() {
        ...
        try {
            const res = await fetch(getApiUrl('/api/save-map'), {
                method: 'POST',
    ...
    async function loadMap(mapName) {
        ...
        try {
            const res = await fetch(getApiUrl(`/api/load-map/${mapName}`));
